...
class FaissIndex(object):
    ...
    def GET_FAISS_ID_TO_VECTOR(self):
        import pickle
        import os
    ...
    def __init__(self):
        # assert id_to_vector
        self.index = faiss.read_index('/tmp/pycharm_project_308/resources/index')

        self.id_to_vector = self.GET_FAISS_ID_TO_VECTOR()
    ...
    def __search__(self, ids, vectors, topN):
        ...
        def result_dict_str(id_, neighbors):
            return dict(id=id_, neighbors=neighbors)
